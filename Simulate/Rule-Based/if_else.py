...
class RuleBasedAnomalyDetector:
    ...
    def __init__(self):
        ...
        # 根据提供的规则定义正常值范围
        self.rules = {
            1: {'min': 0.0, 'max': 10.0, 'description': '发生器1正常值范围: 0~10'},
            2: {'min': 1000.0, 'max': 30000.0, 'description': '发生器2正常值范围: 1000~30000'},
            3: {'min': -80.0, 'max': -20.0, 'description': '发生器3正常值范围: -80~-20'},
            4: {'min': -3.9, 'max': 82.7, 'description': '发生器4正常值范围: -3.9~82.7'},
            5: {'min': -1000.0, 'max': 2000.0, 'description': '发生器5正常值范围: -1000~2000'}
        }
