...
class ModelAnalyzer:
    ...
    def _create_model(self):
        ...
        return Edge1DCLSTM(**self.config)
    ...
    def generate_detailed_report(self, results, dataset_name="推理数据集"):
        ...
        print(f"\n{'=' * 80}")
        print(f"1DCNN-LSTM模型推理分析报告 - {dataset_name}")
        print(f"{'=' * 80}")
...
def main():
    ...
    # 配置参数
    MODEL_PATH = "hybrid_precision_model.pth"  # 训练好的模型路径
